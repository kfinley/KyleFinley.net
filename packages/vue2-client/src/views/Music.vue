<template>
  <div class="container">
    ...
    <ul>
      <li>
        <em><a href="https://dirtyworksjazz.com" target="DirtyWorks">Dirty Works Jazz Band</a></em> - This is the group I run. I use this
        group for my jams as well as gigs. We're a modern straight ahead jazz group focusing on the classic era of Jazz (40's to 60's).
        Bebob, Harb-Bop, & Soul Jazz are our roots. We swing harder than a tree in a storm.
      </li>
      <li><em>Viajó de la Musica Quartet</em> - Sometimes I sit in with the group at Scope Divino on Thursdays.</li>
      <li>
      ...
      <li>
        ...
        morning show always feels good.
      </li>
    </ul>
    ...
    <ul>
      <li>
        <em
          ><a href="https://dirtyworksjazz.com/persona-jazz-jam" target="DirtyWorks">Dirty Works Jazz Jam</a> @
      ...
      <li>
        <em
          ><a href="https://dirtyworksjazz.com/paris-75-jazz-jam" target="DirtyWorks">Dirty Works & Friends</a> @
      ...
      <li>
        ...
        in Alamo Square. This is known as "The" jam in town and you can find most the younger players here doing their thing.
      </li>
      <li>
      ...
      <li>
        ...
        - This is the longest running bluegrass jam in San Francisco. The jam is run by a great crew and Mr. Frank Holmes is back leading
        the band as often as he can. This jam is back on track and kickin just about as strong as ever!
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        acoustically and comprises of guitar, bass flute, and double bass.
      </li>
      <li>
      ...
      <li><em>Angel Island</em> - Golden Gate Park Jazz septet with saxes, trumpet, flute, guitar, bass, and drums.</li>
      <li>
