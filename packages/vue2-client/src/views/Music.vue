<template>
  <div class="container">
    ...
    <p>
      ...
      <ul>
        <li><a href="https://www.thebash.com/bluegrass/nobodyfromnashville" target="new">Nobody From Nashville</a> - Band for hire! Four piece featuring Ian Epstein on guitar, Steve Owen on dobro, and Joan Wilson Rueter on fiddle </li>
        ...
        <li>The Hotel Utah Saloon Weekly Bluegrass Jam - Every Tuesday from 7pm until we're done</li>
