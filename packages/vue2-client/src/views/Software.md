...
<div class="timeline">
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      ...
      <p>
        <a href="https://www.nuget.org/packages/EFContinuousMigrations" target="new">EFContinuousMigrations</a> is an Entity Framework Core extension for conditionally applying pending migrations to a database at runtime using application configuration settings.
      </p>
   </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      <h3>EFQuerySpecs</h3>
      <p>
        <a href="https://www.nuget.org/packages/EFQuerySpecs" target="new">EFQuerySpecs </a>is a lightweight Domain Driven Design Specification pattern implementation for Entity Framework Core.
      </p>
   </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      ...
      <p>
        <a href="https://www.nuget.org/packages/ServiceProviderFunctions" target="new">Service Provider Functions</a>  is a small libary (1 class) that takes care of the .net core IServiceCollection dependency injection boilerplate code for AWS Lambda Functions.
      </p>
   </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      <h3>AppSettings.FeatureFlags</h3>
      <p>
        <a href="https://www.nuget.org/packages/AppSettings.FeatureFlags" target="new">AppSettings.FeatureFlags</a> is a very simple feature flag system using the standard dotnet configuration system using file appsettings.json file(s).
      </p>
     </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      <h3>SUT</h3>
      <p>
        <a href="https://www.nuget.org/packages/SUT" target="new">SUT</a> is a wrapper class for any .net class that you want to treat as a System Under Test for the purpose of code level testing. It provides assistance with automocking and swapping out reals for fakes when needed.
      </p>
    </div>
  </div>
...
<div class="timeline">
  ...
  <div class="timeline-item">
    <div class="timeline-item-content">
      ...
      <p class="no-indent">Bend Financial was acquired by HSA Bank in 2022.</p>
    </div>
  </div>
