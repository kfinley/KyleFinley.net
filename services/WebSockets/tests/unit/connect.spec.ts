...
describe("connect", () => {
  ...
  const context = {
    ...
    functionName: 'KyleFinley-Dev-WebSockets-connect',
    functionVersion: '$LATEST',
    identity: undefined,
    invokedFunctionArn: 'offline_invokedFunctionArn_for_KyleFinley-Dev-WebSockets-connect',
    logGroupName: 'offline_logGroupName_for_KyleFinley-Dev-WebSockets-connect',
    logStreamName: 'offline_logStreamName_for_KyleFinley-Dev-WebSockets-connect',
