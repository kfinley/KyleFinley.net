...
var SendMessageCommand = /** @class */ (function () {
    ...
    SendMessageCommand.prototype.runAsync = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var output;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.send(new client_apigatewaymanagementapi_1.PostToConnectionCommand({
    ...
    __decorate([
        (0, inversify_props_1.Inject)("ApiGatewayManagementApiClient")
    ], SendMessageCommand.prototype, "client");
